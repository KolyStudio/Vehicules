  ...
  return (
    ...
    <img
              ...
              />
               ...
               <div className="lg:pl-0 pl-6" >You came here from <strong className="text-primary">Facebook</strong>, congrats. We applied <strong className="text-primary">50% OFF special discount</strong>
              </div>
    </section>
  );
}
