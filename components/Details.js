    ...
    <section className='z-0 w-[100%] '>
      ...
      <article className='p-4 lg:max-w-[800px] lg:min-w-[600px] lg:pt-10 '>
        ...
        <article className='flex items-center space-x-1 py-2'>
          <span className='text-xl font-semibold text-[#1b74e4]'>
            {quantity == 1 ? (
        ...
        <section className='mt-1  flex flex-col space-y-1   md:m-auto lg:m-0 '>
          ...
          <article
            ...
            className={`relative w-full cursor-pointer p-1 rounded-xl border-[2px] text-center ${
              quantity == 1 ? "bg-[#eef2fd] border-blue-400 text-black " : ""
            }`}>
              <div className='flex items-center justify-between'>
            {quantity == 1 ? (

<div className='w-[25px] bg-[#1b74e4] h-[20px] rounded-full border-[3px] border-blue-400'></div>
            ) : (
            ...
            <div className='flex flex-col'>
              ...
              quantity == 1 ? "border-black  text-[#1b74e4]" : "text-[#1b74e4]"}`}>£{produit.price.toFixed(2)}</span>
          ...
          <article
            ...
            className={`relative w-full cursor-pointer p-1 rounded-xl border-[2px] text-center ${
              quantity == 2 ? "bg-[#eef2fd] border-blue-400 text-black" : ""
            }`}>
              <div className='flex items-center justify-between'>
...
<div className='w-[25px] bg-[#1b74e4] h-[20px] rounded-full border-[3px] border-blue-400'></div>
            ...
            <div className='flex flex-col'>
              <span className={` font-bold ${
              quantity == 2 ? " text-[#1b74e4]" : "text-[#1b74e4]"}`}>£{(produit.price * 1.5).toFixed(2)}</span>
          ...
          <article
            ...
            className={`relative w-full cursor-pointer p-1 rounded-xl border-[2px] text-center ${
              quantity == 3 ? "bg-[#eef2fd] border-blue-400 text-black" : ""
            }`}>
              <div className='flex items-center justify-between'>
            {quantity == 3 ? (
...
<div className='w-[25px] bg-[#1b74e4] h-[20px] rounded-full border-[3px] border-blue-400'></div>
            ...
            <div className='flex flex-col'>
              <span className={` font-bold ${
              quantity == 3 ? "text-[#1b74e4]" : "text-[#1b74e4]"}`}>£{(produit.price * 2).toFixed(2)}</span>
        ...
        <section className=' md:m-auto lg:m-0'>
          <button
            onClick={AddToCart}
            className='mt-5 flex w-full items-center justify-center  p-2 py-3.5 font-medium bg-[#1b74e4] text-white  tracking-wider rounded-xl'>
            {loading ? (
              <svg
